...
export const WEAPONS = {
  ashen_blade: {
    ...
    specialId: 'burning_cleave', specialCooldown: 5, specialCost: 20, specialLabel: 'cleave',
  ...
  ironbreaker: {
    ...
    specialId: 'quake', specialCooldown: 7, specialCost: 28, specialLabel: 'quake',
  ...
  voidlance: {
    ...
    specialId: 'throw_lance', specialCooldown: 6, specialCost: 22, specialLabel: 'throw',
  ...
  phase_daggers: {
    ...
    specialId: 'phase_dash', specialCooldown: 4, specialCost: 18, specialLabel: 'dash',
  ...
  force_gauntlet: {
    ...
    specialId: 'force_blast', specialCooldown: 5, specialCost: 24, specialLabel: 'blast',
  ...
  ember_bow: {
    ...
    specialId: 'fire_trail', specialCooldown: 6, specialCost: 18, specialLabel: 'trail',
  ...
  tidecaster: {
    ...
    specialId: 'tide_wave', specialCooldown: 5, specialCost: 20, specialLabel: 'wave',
    view: {
  ...
  convergence_staff: {
    ...
    specialId: 'cycle_element', specialCooldown: 0.35, specialCost: 0, specialLabel: 'cycle',
